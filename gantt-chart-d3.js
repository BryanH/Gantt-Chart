...
d3.gantt = function() {
    ...
    */
    var getChartnode = function() {
        var chartnode = d3.select("body").selectAll("svg").data([id], function(d) {
            return d;
    ...
    var initTimeDomain = function(tasks) {
        if (timeDomainMode === FIT_TIME_DOMAIN_MODE) {
            ...
            timeDomainStart = tasks.reduce(function(a, b) {
                return a.startDate < b.startDate ? a : b
            }).startDate;
            timeDomainEnd = tasks.reduce(function(a, b) {
    ...
    var renderAxis = function() {
        ...
        xAxisnode.selectAll(".tick").classed('minor', function(d) {
            return d.getMonth()
        })
    }
    ...
    var drawGrid = function() {
        ...
        gridnode.selectAll("line.gridX")
            .data(timeAxisRenderer.ticks(), function(d) {
                return d;
            })
            .enter().append("line")
            .attr("class", "gridX")
        ...
        gridnode.selectAll("line.gridY").data(categoryAxisRenderer.ticks(), function(d) {
                return d;
            }).enter()
            .append("line")
            .attr("class", "gridY")
    ...
    */
    var isInitialized = function() {
        ...
        var svgSelection = d3.select("body").selectAll("svg").data([id], function(d) {
            return d;
        })
    ...
    var drawDateLines = function(dateLines) {
        ...
        var taskGSelection = barnode.selectAll("g").data(visibleDL, function(d) {
            return d.date;
        });
    ...
    var resizeChart = function() {
        var svgElement = d3.select("body").select("svg").data([id], function(d) {
            return d;
        });
...
d3.timeAxisRenderer = function() {
    ...
    timeAxisRenderer.ticks = function() {
            var domainValues = x.ticks(10)
            var tickPositions = domainValues.map(function(d) {
                return x(d);
            })
...
d3.categoryAxisRenderer = function() {
    ...
    categoryAxisRenderer.init = function() {
        ...
        for (var c = 0; c < categories.length; c++) {
            ...
            categoriesRanges[category] = {
                "taskIni": ini,
                "taskEnd": (ini + taskBandH),
                "mStoneIni": (ini + taskBandH),
                "mStoneEnd": end
            };
            ini = end;
        }
    ...
    categoryAxisRenderer.position = function(d) {
      var ypos, categoryTaskRange, categoryMsRange;
    ...
    categoryAxisRenderer.draw = function(node) {
        ...
        node.selectAll("g").data(categories, function(d) {
                return d;
            }).enter()
            .append("g")
    ...
    taskRenderer.draw = function(node) {
        ...
        node.append("rect")
            ...
            .attr("class", function(d) {
                if (hasOwnProperty(d, "class")) return d.class + "-bar";
                else return "task-bar";
            })
        ...
        node.append("rect")
            ...
            .attr("class", function(d) {
                if (hasOwnProperty(d, "class")) return d.class + "-progress-bar";
                else return "task-progress-bar";
            })
            .call(assignEvent);
        ...
        node.append("text")
            .attr("y", function(d) {
                return 3 + config.barHeight / 2;
            })
            .attr("x", 5)
            .attr("class", function(d) {
                if (hasOwnProperty(d, "class")) return d.class + "-label";
...
d3.msRenderer = function() {
    ...
    msRenderer.draw = function(node) {
        ...
        node.append("circle")
            ...
            .attr("cy", "0")
            .attr("class", function(d) {
                if (hasOwnProperty(d, "class")) return d.class + "-mark";
                else return "milestone-mark";
            })
            .attr("style", function(d) {
                return d.style;
            })
...
d3.datelineRenderer = function() {
    ...
    datelineRenderer.draw = function(node) {
        node.append("line")
            ...
            .attr("class", function(d) {
                if (hasOwnProperty(d, "class")) return d.class + "-line";
                else return "dateline-line";
            })
            .attr("style", function(d) {
                return d.style;
            });
